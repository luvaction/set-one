...
## App Store Permanent Info (Version Independent)

### Promotional Text (Max 170 characters)

One-tap workout tracking! No complex inputs. Just focus on your workout. Ad-free, completely free. Start your fitness journey with Set1 today!

### App Description

Set1 is the easiest workout tracking app.

Other apps require 5 taps to record a single set, but Set1 only needs one tap.

Key Features:
- One-Tap Recording: Complete sets with a single tap
- Smart Input: Auto-fill previous weight and reps
- Meaningful Statistics: Only the data you actually need
- Routine Management: Save and execute your custom workout routines
- Workout History: Automatically save all your workout records
- Progress Tracking: Personal records (PR) and weekly comparisons
- Completely Free: No ads, no subscriptions
- Offline Support: All features work without internet

Focus on your workout. Let Set1 handle the recording.

### Keywords (Max 100 chars, comma separated)

workout,fitness,gym,training,exercise,strength,bodyweight,tracker,routine,health
